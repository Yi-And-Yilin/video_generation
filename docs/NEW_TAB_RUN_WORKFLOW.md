...
A **Type** dropdown allows switching between **Tag** mode (full 3-phase pipeline) and **Z** mode (LLM generates complete prompts directly, skipping Phase 3). The default mode is **Z**.
